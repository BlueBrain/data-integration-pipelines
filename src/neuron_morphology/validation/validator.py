...
validation_report_checks = {
    'morphology': {
        'can_be_loaded_with_morphio': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: CheckResult(
    ...
    'neurites': {
        ...
        'has_no_dangling_branch': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_no_dangling_branch(neuron),
        ...
        'has_no_root_node_jump': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_no_root_node_jumps(neuron),
        ...
        'has_no_z_jumps': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_no_jumps(neuron, axis='z'),
        ...
        'has_no_narrow_start': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_no_narrow_start(neuron, frac=0.9),
        ...
        'has_no_fat_ends': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_no_fat_ends(neuron),
        ...
        'has_all_nonzero_segment_lengths': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_all_nonzero_segment_lengths(neuron),
            example_failure=[
        ...
        "has_all_nonzero_neurite_radii": Check(
            ...
            value_in_json=None,
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_all_nonzero_neurite_radii(m),
        ...
        "has_all_nonzero_section_lengths": Check(
            ...
            value_in_json=None,
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_all_nonzero_section_lengths(m),
        ...
        'has_no_narrow_neurite_section': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_no_narrow_neurite_section(neuron, neurite_filter=None),
        ...
        "has_no_flat_neurites": Check(
            ...
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_no_flat_neurites(m, 1e-6, method="tolerance"),
    ...
    'bifurcations': {
        'has_unifurcation': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_unifurcation(neuron),
        ...
        'has_multifurcation': Check(
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: morphology_checks.has_multifurcation(neuron),
    ...
    "soma": {
        "has_nonzero_soma_radius": Check(
            ...
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_nonzero_soma_radius(m),
    ...
    'dendrites': {
        "has_apical_dendrite": Check(
            ...
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_apical_dendrite(m),
        ...
        "has_basal_dendrite": Check(
            ...
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_basal_dendrite(m),
    ...
    'axons': {
        "has_axon": Check(
            ...
            pref_label="Has axon",
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: morphology_checks.has_axon(m),
    ...
    'custom': {
        'has_no_heterogeneous_neurites': Check(
            ...
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: custom_validation.has_no_heterogeneous_neurites(m),
            value_in_tsv=(Check.basic_tsv, True)
        ),
        'has_no_heterogeneous_neurites_near_soma': Check(
            ...
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: custom_validation.has_no_heterogeneous_sections_close_to_soma(m, no_min=False, min_soma_distance=40),
        ...
        'has_no_composite_subtree_type_starting_in_axon': Check(
            ...
            value_in_json=lambda neuron_path, k_1, k_2, x: x.status,
            callable_=lambda m, swc_path, brain_region_map, volume_path: custom_validation.has_no_composite_subtree_type_starting_in_axon(m),
        ...
        'number_of_dendritic_trees_stemming_from_the_soma': Check(  # DONE
            ...
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: custom_validation.number_of_dendritic_trees_stemming_from_the_soma(neuron),
        ...
        'number_of_axons': Check(  # DONE
            ...
            value_in_json=Check.basic_numeric,
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: custom_validation.number_of_axons(neuron),
            value_in_tsv=(Check.basic_numeric, None)
        ),
        ...
        'max_branch_order':  Check(  # DONE
            ...
            value_in_json=Check.basic_numeric,
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: int(max(nm.features.get('section_branch_orders', neuron))),
            unit_code="μm",
        ...
        'total_section_length': Check(  # DONE
            ...
            value_in_json=Check.basic_numeric,
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: float(nm.features.get('total_length', neuron)),
            unit_code="μm",
            example_failure=None,
            value_in_tsv=(Check.basic_numeric, None)
        ),
        'max_section_length': Check(  # DONE
            ...
            value_in_json=Check.basic_numeric,
            callable_=lambda neuron, swc_path, brain_region_map, volume_path: float(max(nm.features.get('section_lengths', neuron))),
            unit_code="μm",
            example_failure=None,
            value_in_tsv=(Check.basic_numeric, None)
        ),
